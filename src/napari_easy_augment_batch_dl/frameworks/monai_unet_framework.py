...
@dataclass
class MonaiUNetFramework(BaseFramework):
    """
    Monai UNET Framework
    
    This framework is used to train a Monai UNET Semantic Segmentation model.
    ...
    def __init__(self, parent_path: str,  num_classes: int, start_model: str = None):
        ...
        self.model_name = self.generate_model_name('monai_unet')
...
BaseFramework.register_framework('VesselsSemanticFramework', MonaiUNetFramework)
